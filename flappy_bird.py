...
class Bird(object):
    ...
    def birdUpdate(self):
        if self.jump:
            # 小鸟跳跃
            self.jumpSpeed -= 0.4  # 跳跃高度递减，上升越来越慢
...
def createMap():
    ...
    Bird.birdUpdate() # 鸟移动
    # 显示分数
    screen.blit(font.render('Score:'+str(score),True,(255,255,255)),(100,50)) # 设置颜色坐标
...
def getResult1():
    ...
    ft1_surf = font.render(final_text1,1,(242,3,36))  # 设置第行文字颜色
    ft2_font = pygame.font.SysFont('Arial',50)  # 设置第一行文字字体
    ft2_surf = font.render(final_text2,1,(253,177,6))  # 设置第行文字颜色
    # 设置第一行文字显示位置
...
if __name__ == '__main__':
    ...
    font = pygame.font.SysFont('ziti.tiff',50)  # 设置字体和大小
